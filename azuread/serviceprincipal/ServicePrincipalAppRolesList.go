...
func (j *jsiiProxy_ServicePrincipalAppRolesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServicePrincipalAppRolesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServicePrincipalAppRolesList {
	_init_.Initialize()
...
func NewServicePrincipalAppRolesList_Override(s ServicePrincipalAppRolesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServicePrincipalAppRolesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServicePrincipalAppRolesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServicePrincipalAppRolesList) Resolve(context cdktn.IResolveContext) interface{} {
