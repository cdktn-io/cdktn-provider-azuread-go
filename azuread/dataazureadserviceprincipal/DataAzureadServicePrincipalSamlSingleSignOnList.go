...
func (j *jsiiProxy_DataAzureadServicePrincipalSamlSingleSignOnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzureadServicePrincipalSamlSingleSignOnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzureadServicePrincipalSamlSingleSignOnList {
	_init_.Initialize()
...
func NewDataAzureadServicePrincipalSamlSingleSignOnList_Override(d DataAzureadServicePrincipalSamlSingleSignOnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzureadServicePrincipalSamlSingleSignOnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzureadServicePrincipalSamlSingleSignOnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadServicePrincipalSamlSingleSignOnList) Resolve(context cdktn.IResolveContext) interface{} {
