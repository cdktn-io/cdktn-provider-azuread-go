...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azuread.conditionalAccessPolicy.ConditionalAccessPolicyConditionsApplicationsFilter",
		reflect.TypeOf((*ConditionalAccessPolicyConditionsApplicationsFilter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-azuread.conditionalAccessPolicy.ConditionalAccessPolicyConditionsApplicationsFilterOutputReference",
		reflect.TypeOf((*ConditionalAccessPolicyConditionsApplicationsFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
