...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-azuread.servicePrincipalTokenSigningCertificate.ServicePrincipalTokenSigningCertificateConfig",
		reflect.TypeOf((*ServicePrincipalTokenSigningCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-azuread.servicePrincipalTokenSigningCertificate.ServicePrincipalTokenSigningCertificateTimeouts",
