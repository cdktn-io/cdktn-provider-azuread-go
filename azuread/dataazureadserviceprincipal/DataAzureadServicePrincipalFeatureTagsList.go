...
func (j *jsiiProxy_DataAzureadServicePrincipalFeatureTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzureadServicePrincipalFeatureTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzureadServicePrincipalFeatureTagsList {
	_init_.Initialize()
...
func NewDataAzureadServicePrincipalFeatureTagsList_Override(d DataAzureadServicePrincipalFeatureTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzureadServicePrincipalFeatureTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzureadServicePrincipalFeatureTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadServicePrincipalFeatureTagsList) Resolve(context cdktn.IResolveContext) interface{} {
