...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/privilegedaccessgroupeligibilityschedule/internal"
...
func (j *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewPrivilegedAccessGroupEligibilitySchedule(scope constructs.Construct, id *string, config *PrivilegedAccessGroupEligibilityScheduleConfig) PrivilegedAccessGroupEligibilitySchedule {
	...
	_jsii_.Create(
		"@cdktn/provider-azuread.privilegedAccessGroupEligibilitySchedule.PrivilegedAccessGroupEligibilitySchedule",
...
func (j *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PrivilegedAccessGroupEligibilitySchedule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PrivilegedAccessGroupEligibilitySchedule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
