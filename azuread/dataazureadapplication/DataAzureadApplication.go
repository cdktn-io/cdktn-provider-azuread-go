...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/dataazureadapplication/internal"
...
type DataAzureadApplication interface {
	...
	Description() *string
	DeviceOnlyAuthEnabled() cdktn.IResolvable
	DisabledByMicrosoft() *string
	DisplayName() *string
	SetDisplayName(val *string)
	DisplayNameInput() *string
	FallbackPublicClientEnabled() cdktn.IResolvable
	...
	Oauth2PostResponseRequired() cdktn.IResolvable
	ObjectId() *string
...
func (j *jsiiProxy_DataAzureadApplication) AppRoleIds() cdktn.StringMap {
...
func (j *jsiiProxy_DataAzureadApplication) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzureadApplication) DeviceOnlyAuthEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzureadApplication) FallbackPublicClientEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzureadApplication) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzureadApplication) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzureadApplication) Oauth2PermissionScopeIds() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzureadApplication) Oauth2PostResponseRequired() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzureadApplication) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzureadApplication) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAzureadApplication)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzureadApplication)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzureadApplication)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzureadApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzureadApplication) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzureadApplication) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzureadApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
