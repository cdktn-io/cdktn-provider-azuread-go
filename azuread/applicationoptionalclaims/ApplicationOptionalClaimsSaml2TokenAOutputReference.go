...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/applicationoptionalclaims/internal"
...
func (j *jsiiProxy_ApplicationOptionalClaimsSaml2TokenAOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationOptionalClaimsSaml2TokenAOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApplicationOptionalClaimsSaml2TokenAOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azuread.applicationOptionalClaims.ApplicationOptionalClaimsSaml2TokenAOutputReference",
...
func NewApplicationOptionalClaimsSaml2TokenAOutputReference_Override(a ApplicationOptionalClaimsSaml2TokenAOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationOptionalClaimsSaml2TokenAOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationOptionalClaimsSaml2TokenAOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationOptionalClaimsSaml2TokenAOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApplicationOptionalClaimsSaml2TokenAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationOptionalClaimsSaml2TokenAOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
