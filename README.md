# CDKTN Go bindings for hashicorp/azuread provider version 3.8.0
...
Find auto-generated docs for this provider [here](https://github.com/cdktn-io/cdktn-provider-azuread/blob/main/docs/API.go.md).
