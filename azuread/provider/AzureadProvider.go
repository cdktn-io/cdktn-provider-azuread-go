...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/provider/internal"
...
func (a *jsiiProxy_AzureadProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
