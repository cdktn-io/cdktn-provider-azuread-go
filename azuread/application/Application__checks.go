...
func (a *jsiiProxy_Application) validatePutAppRoleParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ApplicationAppRole; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_Application) validatePutFeatureTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ApplicationFeatureTags; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_Application) validatePutRequiredResourceAccessParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ApplicationRequiredResourceAccess; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Application) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
