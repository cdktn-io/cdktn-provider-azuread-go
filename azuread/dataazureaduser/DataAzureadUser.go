...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/dataazureaduser/internal"
...
type DataAzureadUser interface {
	...
	ShowInAddressList() cdktn.IResolvable
	State() *string
...
func (j *jsiiProxy_DataAzureadUser) AccountEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAzureadUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzureadUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzureadUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzureadUser) OnpremisesSyncEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzureadUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzureadUser) ShowInAddressList() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"showInAddressList",
...
func (j *jsiiProxy_DataAzureadUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAzureadUser(scope constructs.Construct, id *string, config *DataAzureadUserConfig) DataAzureadUser {
	...
	_jsii_.Create(
		"@cdktn/provider-azuread.dataAzureadUser.DataAzureadUser",
...
func (j *jsiiProxy_DataAzureadUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzureadUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzureadUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzureadUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzureadUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzureadUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzureadUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
