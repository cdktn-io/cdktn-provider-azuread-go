...
func (j *jsiiProxy_DataAzureadServicePrincipalFeaturesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzureadServicePrincipalFeaturesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzureadServicePrincipalFeaturesList {
	_init_.Initialize()
...
func NewDataAzureadServicePrincipalFeaturesList_Override(d DataAzureadServicePrincipalFeaturesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzureadServicePrincipalFeaturesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzureadServicePrincipalFeaturesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadServicePrincipalFeaturesList) Resolve(context cdktn.IResolveContext) interface{} {
