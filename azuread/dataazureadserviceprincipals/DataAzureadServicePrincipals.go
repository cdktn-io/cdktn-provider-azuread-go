...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/dataazureadserviceprincipals/internal"
...
func (j *jsiiProxy_DataAzureadServicePrincipals) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzureadServicePrincipals) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzureadServicePrincipals) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzureadServicePrincipals) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzureadServicePrincipals) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAzureadServicePrincipals(scope constructs.Construct, id *string, config *DataAzureadServicePrincipalsConfig) DataAzureadServicePrincipals {
	...
	_jsii_.Create(
		"@cdktn/provider-azuread.dataAzureadServicePrincipals.DataAzureadServicePrincipals",
...
func (j *jsiiProxy_DataAzureadServicePrincipals)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzureadServicePrincipals)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzureadServicePrincipals)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzureadServicePrincipals_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzureadServicePrincipals) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzureadServicePrincipals) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzureadServicePrincipals) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
