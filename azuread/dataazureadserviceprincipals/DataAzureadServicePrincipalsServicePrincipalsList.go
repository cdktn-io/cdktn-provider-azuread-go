...
func (j *jsiiProxy_DataAzureadServicePrincipalsServicePrincipalsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzureadServicePrincipalsServicePrincipalsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzureadServicePrincipalsServicePrincipalsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-azuread.dataAzureadServicePrincipals.DataAzureadServicePrincipalsServicePrincipalsList",
...
func NewDataAzureadServicePrincipalsServicePrincipalsList_Override(d DataAzureadServicePrincipalsServicePrincipalsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzureadServicePrincipalsServicePrincipalsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzureadServicePrincipalsServicePrincipalsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadServicePrincipalsServicePrincipalsList) Resolve(context cdktn.IResolveContext) interface{} {
