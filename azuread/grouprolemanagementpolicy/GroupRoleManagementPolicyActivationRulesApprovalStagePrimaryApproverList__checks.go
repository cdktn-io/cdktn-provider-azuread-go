...
func (g *jsiiProxy_GroupRoleManagementPolicyActivationRulesApprovalStagePrimaryApproverList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_GroupRoleManagementPolicyActivationRulesApprovalStagePrimaryApproverList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*GroupRoleManagementPolicyActivationRulesApprovalStagePrimaryApprover; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_GroupRoleManagementPolicyActivationRulesApprovalStagePrimaryApproverList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGroupRoleManagementPolicyActivationRulesApprovalStagePrimaryApproverListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
