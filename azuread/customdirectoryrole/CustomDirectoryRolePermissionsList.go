...
func (j *jsiiProxy_CustomDirectoryRolePermissionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCustomDirectoryRolePermissionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CustomDirectoryRolePermissionsList {
	_init_.Initialize()
...
func NewCustomDirectoryRolePermissionsList_Override(c CustomDirectoryRolePermissionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CustomDirectoryRolePermissionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CustomDirectoryRolePermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CustomDirectoryRolePermissionsList) Resolve(context cdktn.IResolveContext) interface{} {
