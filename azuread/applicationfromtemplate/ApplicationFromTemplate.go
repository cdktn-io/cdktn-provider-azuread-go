...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/applicationfromtemplate/internal"
...
func (j *jsiiProxy_ApplicationFromTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApplicationFromTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApplicationFromTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApplicationFromTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApplicationFromTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewApplicationFromTemplate(scope constructs.Construct, id *string, config *ApplicationFromTemplateConfig) ApplicationFromTemplate {
	...
	_jsii_.Create(
		"@cdktn/provider-azuread.applicationFromTemplate.ApplicationFromTemplate",
...
func (j *jsiiProxy_ApplicationFromTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApplicationFromTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApplicationFromTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApplicationFromTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApplicationFromTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationFromTemplate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApplicationFromTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationFromTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
