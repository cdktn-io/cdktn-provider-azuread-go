...
import (
	...
	"github.com/cdktn-io/cdktn-provider-azuread-go/azuread/v16/dataazureadgroups/internal"
...
func (j *jsiiProxy_DataAzureadGroups) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAzureadGroups) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAzureadGroups) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAzureadGroups) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAzureadGroups) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataAzureadGroups(scope constructs.Construct, id *string, config *DataAzureadGroupsConfig) DataAzureadGroups {
	...
	_jsii_.Create(
		"@cdktn/provider-azuread.dataAzureadGroups.DataAzureadGroups",
...
func (j *jsiiProxy_DataAzureadGroups)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAzureadGroups)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAzureadGroups)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAzureadGroups_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAzureadGroups) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzureadGroups) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAzureadGroups) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
