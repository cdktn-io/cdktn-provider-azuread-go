...
func (j *jsiiProxy_DataAzureadApplicationWebImplicitGrantList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAzureadApplicationWebImplicitGrantList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzureadApplicationWebImplicitGrantList {
	_init_.Initialize()
...
func NewDataAzureadApplicationWebImplicitGrantList_Override(d DataAzureadApplicationWebImplicitGrantList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzureadApplicationWebImplicitGrantList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzureadApplicationWebImplicitGrantList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadApplicationWebImplicitGrantList) Resolve(context cdktn.IResolveContext) interface{} {
